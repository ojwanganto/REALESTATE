...
public class TenancyAgreementModel {
    ...
    private String agentName = "ELDOWEB NETWORK ENTERPRISES LIMITED";
    private String agentAddress = "P.O BOX 1630- 30100 ELDORET";
    private String agentCellPhone = "0720711115";
