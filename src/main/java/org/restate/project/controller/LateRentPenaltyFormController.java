...
@Controller
@RequestMapping("lateRentPenalty.form")
public class LateRentPenaltyFormController {
    @Autowired
    ...
    private static final String FORM_VIEW = "lateRentPenaltyForm";
    ...
    @RequestMapping(method = RequestMethod.GET, value = "lateRentPenalty.form")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "lateRentPenalty.form")
    public String savePayment(
            @ModelAttribute("payment") Payment payment,BindingResult bindingResult) {

        payment.setPaymentType(paymentTypeService.getPaymentTypeById(3));
