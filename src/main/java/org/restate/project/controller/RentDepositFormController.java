...
@Controller
@RequestMapping("rentDeposit.form")
public class RentDepositFormController {
    @Autowired
    ...
    @RequestMapping(method = RequestMethod.GET, value = "rentDeposit.form")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "rentDeposit.form")
